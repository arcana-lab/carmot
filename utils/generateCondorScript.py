...
#  USAGE: python2 generateCondorScript.py template_condor_file final_condor_file [email]
#
def getArgs():
...
def getNewFile(args):
  ...
  with open(args['fromFile'], 'r') as f:
    for line in f:
      ...
      elif (line.startswith('ExperimentPath')):
        newFileAsStr += 'ExperimentPath = ' + args['repoPath'] + '\n'
      else:
